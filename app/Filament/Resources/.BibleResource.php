...
use App\Filament\Resources\BibleResource\RelationManagers;
use App\Filament\Resources\BibleResource\RelationManagers\BooksRelationManager;
...
class BibleResource extends Resource
{
    ...
    protected static ?string $label = 'Versões';

    protected static ?string $cluster = BibleConfig::class;
