            ...
            <div class="flex h-full items-center justify-center">
                <div class="container">
                    <div class="text-white p-4">
                        <div wire:poll>
                            <h1 style="font-family: {{$config->GetFont->name}}; font-size: 4rem; text-align: right;"> {{ $slide['text'] }} </h1>
                            <h4 style="font-family: {{$config->GetFont->name}}; font-size: 2rem; text-align: right;"> {{ $slide['end'] }} </h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed"
            ...
            <div class="flex h-full items-center justify-center">
                <div class="container">
                    <div class="text-white p-4">
                        <div wire:poll>
                            <h1 style="font-size: 4rem; text-align: right;"> {{ $slide['text'] }} </h1>
                            <div style="font-size: 2rem; text-align: right;"> {{ $slide['end'] }} </div>
                        </div>
                    </div>
                </div>
            </div>
